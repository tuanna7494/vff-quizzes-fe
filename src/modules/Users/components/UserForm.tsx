...
import { BUTTON, USER_STATUS } from 'constants/common';
...
export const UserForm: React.FC<UserFormProps> = ({ userId }) => {
  ...
  useEffect(() => {
    if (isEmpty(avatarWatch)) return;
    if (isObject(avatarWatch)) {
  ...
  }, [dispatch, avatarWatch, setValue, isAdd]);
              ...
              <Grid item xs={12}>
                <FormGroup>
                  ...
                  <RHFUpload
                    ...
                    name="avatar"
                    control={control}
                    previousThumb={currentUser?.avatar}
                  />
                </FormGroup>
              </Grid>
